...
SVC_NAME="actions.runner.sujungeee-sujungeee.github.io.sujungui-MacBookPro"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (sujungeee-sujungeee.github.io.sujungui-MacBookPro)"
